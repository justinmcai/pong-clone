...
enum GameStatus { START, WINNER1, WINNER2 };
enum NumBalls { ONE, TWO, THREE };

constexpr float WINDOW_SIZE_MULT = 1.0f;

constexpr int WINDOW_WIDTH = 1200 * WINDOW_SIZE_MULT,
WINDOW_HEIGHT = 900 * WINDOW_SIZE_MULT;
...
constexpr char KANO_SPRITE_FILEPATH[] = "nagi.png",
MAHIRU_SPRITE_FILEPATH[] = "isagi.png",
BALL_SPRITE_FILEPATH[] = "soccer.png",
P1_TEXT_FILEPATH[] = "p1win.png",
P2_TEXT_FILEPATH[] = "p2win.png";

constexpr float MINIMUM_COLLISION_DISTANCE = 1.0f;
constexpr glm::vec3 INIT_SCALE = glm::vec3(1.5f, 3.0f, 0.0f),
INIT_BALL_SCALE = glm::vec3(1.0f, 1.0f, 0.0f),
INIT_TEXT_SCALE = glm::vec3(5.0f, 5.0f, 0.0f),
INIT_POS_KANO = glm::vec3(4.5f, 0.0f, 0.0f),
INIT_POS_MAHIRU = glm::vec3(-4.5f, 0.0f, 0.0f),
...
GameStatus g_game_status = START;
NumBalls g_num_balls = ONE;
ShaderProgram g_shader_program = ShaderProgram();
glm::mat4 g_view_matrix, g_kano_matrix, g_projection_matrix, g_trans_matrix, g_mahiru_matrix, g_ball_matrix, g_ball2_matrix, g_ball3_matrix, g_p1_matrix, g_p2_matrix;
...
void initialise()
{
    ...
    g_p1_texture_id = load_texture(P1_TEXT_FILEPATH);
    g_p2_texture_id = load_texture(P2_TEXT_FILEPATH);
...
void update()
{
    ...
    if (g_game_status == WINNER2) {
        g_p2_matrix = glm::mat4(1.0f);
        g_p2_matrix = glm::scale(g_p2_matrix, INIT_TEXT_SCALE);
    }
